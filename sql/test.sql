...
--         '青方单位3', 203);
INSERT INTO schedule
('name' , site_id, status, red_score, red_foul, cyan_score, cyan_foul, video_path, red_id, cyan_id, winner_id)
VALUES ('赛程4', 104, 1, 9, 1, 10, 2, '/videos/schedule4.mp4', 204, 304, 304);
